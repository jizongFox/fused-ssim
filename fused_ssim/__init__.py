...
class FusedSSIMMap(torch.autograd.Function):
    ...
    def forward(ctx, C1, C2, img1, img2, padding="same", train=True):
        ssim_map, dm_dmu1, dm_dsigma1_sq, dm_dsigma12, dm_dmu2, dm_dsigma2_sq = (
            fusedssim(C1, C2, img1, img2, train)
        )
    ...
    def backward(ctx, opt_grad):
        img1, img2, dm_dmu1, dm_dsigma1_sq, dm_dsigma12, dm_dmu2, dm_dsigma2_sq = (
            ctx.saved_tensors
        )
        ...
        grad_img1 = fusedssim_backward(
            C1, C2, img1, img2, dL_dmap, dm_dmu1, dm_dsigma1_sq, dm_dsigma12
        )
        grad_img2 = fusedssim_backward_img2(
            C1, C2, img1, img2, dL_dmap, dm_dmu2, dm_dsigma2_sq, dm_dsigma12
        )
